export default {
	...
	// 首页-顶部轮播图数据(后台可配置)
	carouselList: [{
			image: '/static/service/讲师介绍.png',
			url: '/pages/trainservice/teacher',
			title: '讲师介绍',
			iconImg: '/static/service/讲师介绍-icon.png',
		},
		{
			image: '/static/service/培训课程.png',
			url: '/pages/trainservice/traincourse',
			title: '培训课程',
			iconImg: '/static/service/培训课程-icon.png',
		},
		{
			image: '/static/service/培训群.png',
			url: '/pages/trainservice/traingroup',
			title: '培训群',
			iconImg: '/static/service/培训群-icon.png',
		},
		{
			image: '/static/service/预约检测.png',
			url: '/pages/checkservice/bookservice/checkbooking',
			title: '预约检测',
			iconImg: '/static/service/预约检测-icon.png',
		},
		{
			image: '/static/service/检测动态.png',
			url: '/pages/checkservice/searchservice/progressSearch',
			title: '检测动态',
			iconImg: '/static/service/检测动态-icon.png',
		},
		{
			image: '/static/service/证书查询.png',
			url: '/pages/checkservice/searchservice/credentialSearch',
			title: '证书查询',
			iconImg: '/static/service/证书查询-icon.png',
		},
	],
	...
	menuList: [{
			url: '/pages/checkservice/bookservice/checkbooking',
			title: '预约检测',
			image: '/static/service/预约检测-icon.png',
		},
		{
			url: '/pages/checkservice/searchservice/progressSearch',
			title: '检测动态',
			image: '/static/service/检测动态-icon.png',
		},
		{
			url: '/pages/checkservice/searchservice/credentialSearch',
			title: '证书查询',
			image: '/static/service/证书查询-icon.png',
		},
		{
			url: '/pages/trainservice/teacher',
			title: '讲师介绍',
			image: '/static/service/讲师介绍-icon.png',
		},
		{
			url: '/pages/trainservice/traincourse',
			title: '培训课程',
			image: '/static/service/培训课程-icon.png',
		},
		{
			url: '/pages/trainservice/traingroup',
			title: '培训群',
			image: '/static/service/培训群-icon.png',
		},
	],
	...
	settingList: [{
		...
		{
			icon: 'icongonggao',
			url: '/pages/user/credential/index',
			title: '电子证书',
			color: '#ff6b81'
		},
		{
		...
		},
		{
			...
			url: '/pages/user/coursevideo/mycourse',
			title: '我的课程',
			color: '#ff6b81'
		},
		{
	...
	amountList: [{
		...
		},
		{
			title: '我的预约',
			value: 0,
			url: '/pages/checkservice/bookservice/minebooking'
		},
		{
			title: '收藏夹',
			value: 0,
