 ...
 */
// 个人信息
const memberInfo = '/api/wxuser/getinfo';
// 个人信息修改
const memberUpdate = '/api/wxuser/update';
...
// 获取我的优惠券列表
const myCouponList = '/api/yxStoreCouponPerson';
// 优惠券详情
const couponDetail = '/tiny-shop/v1/marketing/coupon-type/view';
// 领取优惠券
const couponReceive = '/api/getStoreCoupon';
const couponClear = '/api/updateCouponUser';




// 获取我的订单
const orderList = '/api/yxStoreOrder/weixin';
// 订单确认收货
...
// 获取订单详情
const orderDetail = '/api/yxStoreOrder';
// 删除已关闭订单
...
// 收藏列表
const collectList = '/api/wxCourseUser/select';
...
// 上传图片
const uploadBase64Image = '/api/wxuser/updatehead';
// 上传图片
...
// 未读消息个数
const notifyUnRreadCount = '/api/wxOrder/order/un-read-count';
// 消息提醒配置
...
//我的购买课程对应的视频
const myCourseVideo = '/api/wxVideo/selectAllByid'
